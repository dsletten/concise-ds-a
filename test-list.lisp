...
(defun test-list-contains-arithmetic (list-constructor)
  (let ((list (fill (funcall list-constructor) 20)))
    (assert (= (contains list 3) 3) () "Literal 3 should be present in list.")
    (assert (= (contains list 3 :test #'(lambda (item elt) (= elt (1+ item)))) 4) ()
            "List contains the element one larger than 3.")
    (assert (= (contains list 2 :test #'(lambda (item elt) (> elt (* 2 item)))) 5) ()
...
(defun test-list-time (list-constructor)
  ...
  (let ((list (funcall list-constructor)))
    (time (dotimes (i 10 t)
            ...
            (loop until (emptyp list) do (delete list -1)))) ) ; Very fast for HASH-TABLE-LIST/ARRAY-LIST
  (let ((list (funcall list-constructor)))
    (time (progn (fill list 10000)
                 (dotimes (i 10 t)
                   (loop for i from 0 below (size list)
                         do (assert (= (nth list i) (1+ i)) () "~:R element should be: ~A" i (1+ i)))) )))
  (let ((list (funcall list-constructor)))
    (time (progn (fill list 10000)
                 (dotimes (i 10 t)
...
(deftest test-array-list ()
  (check
   ...
   (test-list-contains-predicate #'(lambda () (make-instance 'array-list)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'array-list)))
   (test-list-equals #'(lambda () (make-instance 'array-list)))
   (test-list-equals-predicate #'(lambda () (make-instance 'array-list)))
...
(deftest test-array-list-x ()
  (check
   ...
   (test-list-contains-predicate #'(lambda () (make-instance 'array-list-x)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'array-list-x)))
   (test-list-equals #'(lambda () (make-instance 'array-list-x)))
   (test-list-equals-predicate #'(lambda () (make-instance 'array-list-x)))
...
(deftest test-singly-linked-list ()
  (check
   ...
   (test-list-contains-predicate #'(lambda () (make-instance 'singly-linked-list)))
   ...
   (test-list-equals-predicate #'(lambda () (make-instance 'singly-linked-list)))
...
(deftest test-doubly-linked-list ()
  (check
   ...
   (test-list-contains-predicate #'(lambda () (make-instance 'doubly-linked-list)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'doubly-linked-list)))
   (test-list-equals #'(lambda () (make-instance 'doubly-linked-list)))
   (test-list-equals-predicate #'(lambda () (make-instance 'doubly-linked-list)))
...
(deftest test-doubly-linked-list-ratchet ()
  (check
   (test-list-constructor #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-emptyp #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-size #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-clear #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-contains #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-contains-predicate #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-equals #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-equals-predicate #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-each #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-add #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-insert #'(lambda (&key fill-elt) (make-instance 'doubly-linked-list-ratchet :fill-elt fill-elt :direction :backward)))
   (test-list-insert-fill-zero #'(lambda (&key fill-elt) (make-instance 'doubly-linked-list-ratchet :fill-elt fill-elt :direction :backward)))
   (test-list-insert-negative-index #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-insert-end #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-delete #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-delete-negative-index #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-nth #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-nth-negative-index #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-setf-nth #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-setf-nth-negative-index #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-setf-nth-out-of-bounds #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
   (test-list-index #'(lambda () (make-instance 'doubly-linked-list-ratchet :direction :backward)))
...
(deftest test-doubly-linked-list-hash-table ()
  (check
   (test-list-constructor #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-emptyp #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-size #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-clear #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-contains #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-contains-predicate #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-equals #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-equals-predicate #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-each #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-add #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-insert #'(lambda (&key fill-elt) (make-instance 'doubly-linked-list-hash-table :fill-elt fill-elt)))
   (test-list-insert-fill-zero #'(lambda (&key fill-elt) (make-instance 'doubly-linked-list-hash-table :fill-elt fill-elt)))
   (test-list-insert-negative-index #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-insert-end #'make-doubly-linked-list-hash-table)
   (test-list-delete #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-delete-negative-index #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-nth #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-nth-negative-index #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-setf-nth #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-setf-nth-negative-index #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-setf-nth-out-of-bounds #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
   (test-list-index #'(lambda () (make-instance 'doubly-linked-list-hash-table)))
...
(deftest test-hash-table-list ()
  (check
   ...
   (test-list-contains-predicate #'(lambda () (make-instance 'hash-table-list)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'hash-table-list)))
   (test-list-equals #'(lambda () (make-instance 'hash-table-list)))
   (test-list-equals-predicate #'(lambda () (make-instance 'hash-table-list)))
...
(deftest test-hash-table-list-x ()
  (check
   (test-list-constructor #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-emptyp #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-size #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-clear #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-contains #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-contains-predicate #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-equals #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-equals-predicate #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-each #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-add #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-insert #'(lambda (&key fill-elt) (make-instance 'hash-table-list-x :fill-elt fill-elt)))
   (test-list-insert-fill-zero #'(lambda (&key fill-elt) (make-instance 'hash-table-list-x :fill-elt fill-elt)))
   (test-list-insert-negative-index #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-insert-end #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-delete #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-delete-negative-index #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-nth #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-nth-negative-index #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-setf-nth #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-setf-nth-negative-index #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-setf-nth-out-of-bounds #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-index #'(lambda () (make-instance 'hash-table-list-x)))
...
(deftest test-hash-table-list-z ()
  (check
   (test-list-constructor #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-emptyp #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-size #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-clear #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-contains #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-contains-predicate #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-contains-arithmetic #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-equals #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-equals-predicate #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-each #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-add #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-insert #'(lambda (&key fill-elt) (make-instance 'hash-table-list-z :fill-elt fill-elt)))
   (test-list-insert-fill-zero #'(lambda (&key fill-elt) (make-instance 'hash-table-list-z :fill-elt fill-elt)))
   (test-list-insert-negative-index #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-insert-end #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-delete #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-delete-negative-index #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-nth #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-nth-negative-index #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-setf-nth #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-setf-nth-negative-index #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-setf-nth-out-of-bounds #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-index #'(lambda () (make-instance 'hash-table-list-z)))
