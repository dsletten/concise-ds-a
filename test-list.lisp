...
(deftest test-hash-table-list-x ()
  (check
   ...
   (test-list-equals-test #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-contains #'(lambda () (make-instance 'hash-table-list-x)))
   (test-list-contains-test #'(lambda () (make-instance 'hash-table-list-x)))
   ...
   (test-list-index-test #'(lambda () (make-instance 'hash-table-list-x)))
...
(deftest test-hash-table-list-z ()
  (check
   ...
   (test-list-equals-test #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-contains #'(lambda () (make-instance 'hash-table-list-z)))
   (test-list-contains-test #'(lambda () (make-instance 'hash-table-list-z)))
   ...
   (test-list-index-test #'(lambda () (make-instance 'hash-table-list-z)))
